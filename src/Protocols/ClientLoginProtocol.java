...
public class ClientLoginProtocol {
    ...
    private final String welcomeMessage = "[WORKER] Será iniciado o processo do Login!";
    private final String answerUsername = "[WORKER] Indique o seu username: ";
    private final String answerPassword = "[WORKER] Indique a sua password: ";
    private final String sucessAuthen = "[WORKER] Sucesso na autenticação!";
    private final String erroAuthen = "[WORKER] Erro na autenticação!";
